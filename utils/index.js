...
export const safeDA = (object, props, noResult = false) =>
  props.reduce(
    (prefix, val) => (prefix && prefix[val] ? prefix[val] : noResult),
    object
  );
...
export const apiDateFormat = momentDate =>
  momentDate.format("YYYYMMDDTHHmmss[Z]");

export const paginator = (offset = 0, limit = 20) =>
